<p align="center" class="display-6">Silkroad Pvp Serverler</p>
	...
	<?php 
	include '../config.php';
	$query = $connect->query("select * from pvp_servers where s_game = 'silkroad' AND s_state = 'active' order by id asc LIMIT 12");
