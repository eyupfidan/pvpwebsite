<p align="center" class="display-6">Knight Pvp Serverler</p>
	...
	<?php 
	include '../config.php';
	$query = $connect->query("select * from pvp_servers where s_game = 'knight' AND s_state = 'active' order by id asc LIMIT 12");
